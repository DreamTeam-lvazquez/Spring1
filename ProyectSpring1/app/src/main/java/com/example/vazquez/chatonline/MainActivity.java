...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        photoPerfil = (CircleImageView) findViewById(R.id.photo_perfil);
        name = (TextView) findViewById(R.id.name);
        rvMessage = (RecyclerView) findViewById(R.id.rv_message);
        txtMessage = (EditText) findViewById(R.id.txt_message);
        btnShare = (Button) findViewById(R.id.btn_share);
        btnSharePhoto = (ImageButton) findViewById(R.id.btn_share_photo);
        photoPerfi ="";
        ...
        if(requestCode == PHOTO_SEND && resultCode== RESULT_OK){
            ...
            fotoRerefence.putFile(u).addOnSuccessListener(this, new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    MessageShareActivity m = new MessageShareActivity("Lucy te ha enviado una foto",u.toString(), name.getText().toString(),photoPerfi,"2",ServerValue.TIMESTAMP);
                ...
                fotoRerefence.putFile(u).addOnSuccessListener(this, new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        MessageShareActivity m = new MessageShareActivity("Lucy ha actualizado su foto de perfil",u.toString(), name.getText().toString(),photoPerfi,"2",ServerValue.TIMESTAMP);
                        databaseReference.push().setValue(m);
                        Glide.with(MainActivity.this).load(u.toString()).into(photoPerfil);
